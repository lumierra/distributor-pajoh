...
/**
 * Stok Awal: pilih SATUAN per item (seperti PO/GRN). `qty` disimpan dalam UoM
 * yang dipilih; `qty_base` = hasil konversi (× qty_to_base) yang benar-benar
 * masuk ke stok saat posting.
 */
