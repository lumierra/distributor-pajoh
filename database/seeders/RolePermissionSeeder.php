...
class RolePermissionSeeder extends Seeder
{
    ...
    private function adminMatrix(): array
    {
        return [
            ...
            'inventory.opening' => ['view' => true, 'approve' => true],
            ...
            'sales.so' => ['view' => true, 'create' => true, 'update' => true, 'approve' => true, 'export' => true],
    ...
    private function operatorMatrix(): array
    {
        return [
            ...
            'inventory.opening' => ['view' => true, 'create' => true, 'update' => true],
