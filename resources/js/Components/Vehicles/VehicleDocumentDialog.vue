...
const TYPES = ['STNK', 'BPKB', 'KIR', 'ASURANSI', 'PAJAK_TAHUNAN', 'IZIN_TRAYEK', 'LAINNYA'];
        ...
        <DialogContent class="sm:max-w-[520px] p-0 overflow-hidden">
            <DialogHeader class="px-5 pt-5 pb-3 border-b border-border/70">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <DialogTitle class="text-base font-bold tracking-tight">Upload Dokumen Vehicle</DialogTitle>
                        <DialogDescription class="text-xs text-muted-foreground mt-0.5">
                            STNK/BPKB/KIR/dll. Max 5 MB. jpg/png/pdf.
                        </DialogDescription>
                    </div>
                </div>
            </DialogHeader>
